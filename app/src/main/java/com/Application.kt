...
import com.busandiego.logins.R
...
class Application: Application() {
    ...
    override fun onCreate() {
        ...
        NaverIdLoginSDK.initialize(this, getString(R.string.naver_client_id), getString(R.string.naver_client_secert), getString(R.string.naver_client_name))
    }
